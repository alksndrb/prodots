...
function TileLayoutRight({ img, title, text }) {
  return (
    <div>
      <div className="pt-20 flex flex-col sm:flex-row justify-between">
        <Image
          src={img}
          className="hidden sm:inline w-2/6 object-cover"
          alt="img"
        />
        <div className="flex flex-col items-end justify-center w-full sm:w-2/3 sm:pl-10 py-5 md:pl-36">
          <div>
